...
import profile_pic from "../Components/SocialLinks/profile.jpg"
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={profile_pic} className="w-screen rounded-lg" />
          </div>
          <h1
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://www.instagram.com/manishmarshall.dscet.ac.in/" target="#">
                {" "}
            ...
            >
              <a href="https://www.linkedin.com/in/manish-kumar-319125291/">
                {" "}
            ...
            >
              <a href="https://github.com/manish91023" target="#">
                {" "}
